...
//    Page<RecipeReport> findByRecipeAndUserAndReason(Recipe recipe, User user, Reason reason,Pageable pageable);
    ...
    Page<RecipeReport> findByRecipe_UserAndIsEnableFalse(User user, Pageable pageable);
    Page<RecipeReport> findByRecipe_UserAndIsEnableTrue(User user, Pageable pageable);
    Page<RecipeReport> findByRecipe_User(User user, Pageable pageable);


//    List<RecipeReport> findByRecipe_UserUserIdxAndIsEnable(Long userIdx,Boolean isEnable);
    List<RecipeReport> findByRecipe_UserUserIdx(Long userIdx);

//    List<RecipeReport> findAllByUserUserIdx(Long userIdx);
}
